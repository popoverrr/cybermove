 ...
 *   node scripts/test-frame.mjs [--base http://127.0.0.1:4331] [--tier low] [--cpu 4] [--suffix name] [--desktop]
 */
...
const opt = { base: 'http://127.0.0.1:4331', tier: 'low', cpu: 4, suffix: '', out: 'docs/screens/v3', desktop: false, nogl: false };
