...
export interface SceneState {
  ...
  /** целевой прогресс экранов прямо из скролла (пишет обработчик скролла, сглаживает единый rAF) */
  ...
  debugNight: boolean;
  /** технический слой: строка состояния сцены (пишет Story, показывает DOM) */
  status: string;
